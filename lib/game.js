...
Game.prototype.isTrumpSet = function () {
	return this.trump.suit;
};

Game.prototype.getRelationship = function(playerID){
	var relation = {};
...
Game.prototype.getStatus = function(playerID){		
...
Game.prototype.setDistributionSequence = function(){
...
Game.prototype.pairChecking = function () {
...
Game.prototype.setTrumpSuit = function (suit) {
...
Game.prototype.getTrumpSuit = function () {
	this.trump.open = true;
	this.pairChecking();
	return this.trump.suit;
};

Game.prototype.setBidWinner = function(value,player){
	this.bid.value = value;
	this.bid.player = player.id;
};

Game.prototype.getFinalBidStatus = function(){
	return this.bid;
};
...
Game.prototype.setRoundSequence = function(roundWinner){
...
Game.prototype.isValidCardToThrow = function(cardId,playerHand){
...
Game.prototype.addPlayer = function(name){
	...
	if(this.playerCount() == 4){
		...
		this.shuffleDeck();
		this.distributeCards();
		this.bid.player = this.distributionSequence[0].id;
	}
	return true;
};
...
Game.prototype.distributeCards = function(){
	...
	sequence.forEach(function(player){
		player.hand = player.hand.concat(self.deck.splice(0,4));
	});
	return this;
};

Game.prototype.ableToAskForTrumpSuit = function(playerHand){
	if(this.playedCards.length == 0)
		return false;
