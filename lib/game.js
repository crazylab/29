 ...
 //    },
	...
	setDistributionSequence : function(){
		if(this.distributionSequence.length == 0)
			...
			var firstPlayer = this.distributionSequence.slice(0,1);
			var remainPlayers = this.distributionSequence.slice(1,4)
			this.distributionSequence = remainPlayers.concat(firstPlayer);
		}
