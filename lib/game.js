...
Game.prototype = {
	...
	manipulateBidValueForPair : function (game,bidWinningTeam, opponentTeam) {
	...
	updateScore : function (game) {
		...
		var gainPoint = this.calculateTotalPoint(game[bidWinningTeam].wonCards);
		this.manipulateBidValueForPair(game,bidWinningTeam,opponentTeam);
	...
	calculateTotalPoint : function(teamBucket){
